...
(100, 'Main Street', 'New York City', 'New York', 10001),
(200, 'Broadway', 'Los Angeles', 'California', 90001),
(300, 'Market Street', 'San Francisco', 'California', 94101),
(400, 'Pine Street', 'Seattle', 'Washington', 98101),
(500, 'Michigan Avenue', 'Chicago', 'Illinois', 60601),
(600, 'Pennsylvania Avenue', 'Washington D.C.', 'Washington D.C.', 20001),
(700, 'South Congress Avenue', 'Austin', 'Texas', 78701),
(800, 'Ocean Drive', 'Miami', 'Florida', 33101),
(900, 'Canal Street', 'New Orleans', 'Louisiana', 70112),
(1000, 'Lombard Street', 'San Francisco', 'California', 94133);
...
INSERT INTO Orders (Order_status, orderDATE, totalPrice) VALUES
('Pending', '2024-01-01', 150),
('Delivered', '2024-01-02', 200),
('Cancelled', '2024-01-03', 100),
('Pending', '2024-01-04', 250),
('Delivered', '2024-01-05', 300),
('Pending', '2024-01-06', 180),
('Pending', '2024-01-07', 220),
('Delivered', '2024-01-08', 190),
('Cancelled', '2024-01-09', 210),
('Pending', '2024-01-10', 170),
('Delivered', '2024-01-11', 280),
('Cancelled', '2024-01-12', 320),
('Pending', '2024-01-13', 230),
('Delivered', '2024-01-14', 270),
('Pending', '2024-01-15', 150),
('Pending', '2024-01-16', 200),
('Delivered', '2024-01-17', 180),
('Pending', '2024-01-18', 250),
('Delivered', '2024-01-19', 300),
('Pending', '2024-01-20', 220);
...
(1, 'admin1_password_hash'),
(2, 'admin2_password_hash'),
(3, 'admin3_password_hash'),
(4, 'admin4_password_hash'),
(5, 'admin5_password_hash'),
(6, 'admin6_password_hash'),
(7, 'admin7_password_hash'),
(8, 'admin8_password_hash'),
(9, 'admin9_password_hash'),
(10, 'admin10_password_hash');



INSERT INTO Cart (cart_price, customer_id, book_id) VALUES
(1500, 1, 1),
(1700, 2, 2),
(1800, 3, 3),
(1900, 4, 4),
