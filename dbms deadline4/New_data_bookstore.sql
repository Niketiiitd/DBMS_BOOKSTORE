...
INSERT INTO Vendor (vendor_name, Email, Age, Phone_number, vendor_password, vendor_banned, vendor_incorrect_attempts) VALUES
('Oliver', 'oliverrr@example.com', 35, 1234567896, 'password1', 0, 0),
('June', 'june@example.com', 40, 2345678901, 'password2', 0, 0),
('Agust', 'agust@example.com', 45, 3456789012, 'password3', 0, 0),
('Sophia', 'sophia@example.com', 50, 4567890123, 'password4', 0, 0),
('Ethan', 'ethan@example.com', 55, 5678901234, 'password5', 0, 0),
('Emma', 'emma@example.com', 60, 6789012345, 'password6', 0, 0),
('Mia', 'mia@example.com', 65, 7890123456, 'password7', 0, 0),
('James', 'james@example.com', 70, 8901234567, 'password8', 0, 0),
('Ava', 'ava@example.com', 75, 9012345678, 'password9', 0, 0),
('William', 'william@example.com', 80, 1234567890, 'password10', 0, 0),
('Olivia', 'olivia@example.com', 85, 2345678902, 'password11', 0, 0),
('Isaac', 'isaac@example.com', 90, 3456789013, 'password12', 0, 0),
('Charlotte', 'charlotte@example.com', 95, 4567890124, 'password13', 0, 0),
('Amelia', 'amelia@example.com', 100, 5678901235, 'password14', 0, 0),
('Michael', 'michael@example.com', 105, 6789012346, 'password15', 0, 0),
('Emma', 'emma2@example.com', 110, 7890123457, 'password16', 0, 0),
('Jacob', 'jacob@example.com', 115, 8901234568, 'password17', 0, 0),
('Abigail', 'abigail@example.com', 120, 9012345679, 'password18', 0, 0),
('Elijah', 'elijah@example.com', 125, 1234567895, 'password19', 0, 0),
('Sophia', 'sophia2@example.com', 130, 2345678908, 'password20', 0, 0);
...
INSERT INTO Customer (customer_name, Address_ID, phone_number, email, customer_password, age, is_banned, incorrect_attempts) VALUES
('John Doe', 1, 1234567890, 'john@example.com', 'password1', 30, 0, 0),
('Jane Smith', 2, 2345678901, 'jane@example.com', 'password2', 25, 0, 0),
('Michael Johnson', 3, 3456789010, 'michael@example.com', 'password3', 35, 0, 0),
('Emily Davis', 4, 4567890121, 'emily@example.com', 'password4', 28, 0, 0),
('Christopher Wilson', 5, 5678901232, 'christopher@example.com', 'password5', 40, 0, 0),
('Amanda Martinez', 6, 6789012343, 'amanda@example.com', 'password6', 22, 0, 0),
('David Anderson', 7, 7890123454, 'david@example.com', 'password7', 33, 0, 0),
('Jessica Taylor', 8, 8901234565, 'jessica@example.com', 'password8', 29, 0, 0),
('James Brown', 9, 9012345676, 'james@example.com', 'password9', 45, 0, 0),
('Sarah Thomas', 10, 1234567897, 'sarah@example.com', 'password10', 27, 0, 0),
('Matthew White', 11, 2345678908, 'matthew@example.com', 'password11', 32, 0, 0),
('Jennifer Lee', 12, 3456789019, 'jennifer@example.com', 'password12', 38, 0, 0),
('Daniel Harris', 13, 4567890122, 'daniel@example.com', 'password13', 24, 0, 0),
('Elizabeth Clark', 14, 5678901233, 'elizabeth@example.com', 'password14', 41, 0, 0),
('Christopher Martinez', 15, 6789012344, 'christopher2@example.com', 'password15', 26, 0, 0),
('Linda Lewis', 16, 7890123455, 'linda@example.com', 'password16', 34, 0, 0),
('Thomas Robinson', 17, 8901234566, 'thomas@example.com', 'password17', 31, 0, 0),
('Patricia Walker', 18, 9012345677, 'patricia@example.com', 'password18', 39, 0, 0),
('Matthew Hall', 19, 1234567898, 'matthew2@example.com', 'password19', 36, 0, 0),
('Karen Young', 20, 2345678909, 'karen@example.com', 'password20', 23, 0, 0);
